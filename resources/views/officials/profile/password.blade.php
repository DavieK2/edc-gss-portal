...
<div class="main-container">
    <div class="pd-20 card-box mb-30 m-4 p-4">
        <div class="clearfix">
            <h5 class="mb-30 text-primary">Update Password</h5>
            <hr>
        </div>
        <div class="wizard-content py-3">
            <form action="{{ route('officials.profile.password.update', [$role]) }}" method="POST">
                @csrf
                <section>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label style="font-size:16px ;">Enter Old Password</label>
