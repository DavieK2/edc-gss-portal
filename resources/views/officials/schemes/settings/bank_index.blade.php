                        ...
                        <div class="col-md-6 col-sm-12 text-right">
                            <div class="row float-right">
                                <div class="dropdown p-2">
                                    <a class="btn btn-primary btn-sm" style="font-size: 9pt" href="{{ route('officials.schemes.settings.toggle.bank', [$role,$scheme]) }}">
                                        {{ $scheme->is_bank_payment_enabled ? 'Disable Bank Payments' : 'Enable Bank Payments' }}
                                    </a>
                                </div>
                                <div class="dropdown p-2">
                                    <a class="btn btn-primary btn-sm" style="font-size: 9pt" href="{{ route('officials.schemes.charges.create', [ $role, $scheme, 'bank' ]) }}">
                                        Add New Charge
                                    </a>
                                </div>
                            </div>
                            ...
                            <tbody>
                                @forelse($charges_online ?? [] as $key => $charge)
                                    <tr>
                                        ...
                                        <td>Course</td>
                                        <td>
                                            <a href="{{ route('officials.schemes.charges.edit', [ $role, $scheme, $key, 'course', 'bank' ]) }}" class="btn btn-primary btn-sm" style="font-size:8pt; padding:0.3rem">Edit</a>
                                        </td>
                                    </tr>
                                @empty
                                @endforelse
