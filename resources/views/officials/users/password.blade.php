...
<div class="main-container">
    <div class="pd-20 card-box mb-30 m-4 p-4">
        <div class="clearfix">
            <h5 class="mb-30 text-primary">Change User Password</h5>
            <hr>
        </div>
        <div class="wizard-content py-3">
            <form action="{{ route('officials.users.password.update', [$role, $user]) }}" method="POST">
                @csrf
                <section>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="password" placeholder="Enter New Password" value="1234ADCS" >
                                @error('password')
